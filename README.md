...
## Client-side authentication: The token is essentially a key given to the user for access to specific data on a web app by that specific user.
- [ ] What steps can you take in your web apps to keep your data secure?
## HTTPS encryption, installing security software, keeping your website updated,
## enforcing more strict password requirements. 
- [ ] Describe how web servers work.
## A program using HTTP to serve files that form Web pages to users in response
## to their requests.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
## Create: Post, R: Get, U: Put, D: Delete
